...
extern "C"
{
		...
		gdt_entry gdt[] = {
				...
				//Kernel Code Segment
				GDT_ENTRY(0, 0xFFFFFFF,GDT_PRESENT | GDT_SEGMENT | GDT_RING0 | GDT_EXECUTABLE | GDT_READ_WRITE,
								GDT_GRANULARITY_4K | GDT_PROTECTED_MODE),

				//Kernel Data Segment
				GDT_ENTRY(0, 0xFFFFFFF, GDT_PRESENT | GDT_SEGMENT | GDT_RING0 | GDT_READ_WRITE,
								GDT_GRANULARITY_4K | GDT_PROTECTED_MODE),

				// User Code Segment
				GDT_ENTRY(0, 0xFFFFFFF, GDT_PRESENT | GDT_SEGMENT | GDT_RING3 | GDT_EXECUTABLE | GDT_READ_WRITE,
								GDT_GRANULARITY_4K | GDT_PROTECTED_MODE),

				// User Data Segment
				GDT_ENTRY(0, 0xFFFFFFF, GDT_PRESENT | GDT_SEGMENT | GDT_RING3 | GDT_READ_WRITE,
								GDT_GRANULARITY_4K | GDT_PROTECTED_MODE),
