...
/* integer types */
typedef _UINT8_TYPE__ uint8_t
typedef _UINT16_TYPE__ uint16_t
typedef _UINT32_TYPE__ uint32_t
typedef _UINT64_TYPE__ uint64_t
...
# define INT8_MAX_ __INT8_MAX__
# define INT16_MAX_ __INT16_MAX__
# define INT32_MAX_ __INT32_MAX__
# define INT64_MAX_ __INT64_MAX__
...
# define SIG_ATOMIC_MIN __SIG_AOOMIC_MIN__
